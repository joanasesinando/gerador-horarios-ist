...
describe('TimetableComponent', () => {
  ...
  const COURSES: Course[] = [
    new Course(1, 'C1', 'C01', 4.5, 1, 'P1', TYPES_OF_CLASSES, CAMPUS,
      [
    ...
    new Course(2, 'C2', 'C02', 4.5, 1, 'P1', TYPES_OF_CLASSES, CAMPUS,
      [
    ...
    new Course(3, 'C3', 'C03', 4.5, 1, 'P1', TYPES_OF_CLASSES, CAMPUS,
      [
